...
| -------------------------------------------------- | ------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------- | ---------- |
| Search by Subject                                  | Enter 1 on main screen                                                                | Output: clear_screen and "Please enter the subject:"                                                                               | Successful |
| Search by Publisher                                | Enter 2 on main screen                                                                | Output: clear_screen and "Please enter the publisher:"                                                                             | Successful |
| Search by Title                                    | Enter 3 on main screen                                                                | Output: clear_screen and "Please enter the title"                                                                                  | Successful |
| Quit                                               | Enter 4 on main screen                                                                | Goodbye message appears and user can no longer input to terminal                                                                   | Successful |
| Get list of books by subject                       | On second search screen enter: "Maths"                                                | clear_screen function and list of books with only Maths as subject will appear                                                     | Successful |
| Get list of books by subject                       | On second search screen enter: "History"                                              | clear_screen function and list of books with only History as subject will appear                                                   | Successful |
| Get list of books by subject                       | On second search screen enter: "Art"                                                  | clear_screen function and list of books with only Art as subject will appear                                                       | Successful |
| Get list of books by subject                       | On second search screen enter: "English"                                              | clear_screen function and list of books with only English as subject will appear                                                   | Successful |
| Get list of books by subject                       | On second search screen enter: "Geography"                                            | clear_screen function and list of books with only Geography as subject will appear                                                 | Successful |
| Get list of books by publisher                     | On second search screen enter: "Folens"                                               | clear_screen function and list of books with Folens as publisher will appear                                                       | Successful |
| Get list of books by publisher                     | On second search screen enter: "EDCO"                                                 | clear_screen function and list of books with EDCO as publisher will appear                                                         | Successful |
| Get list of books by publisher                     | On second search screen enter: "CJ Fallon"                                            | clear_screen function and list of books with CJ Fallon as publisher will appear                                                    | Successful |
| Get list of books by publisher                     | On second search screen enter: "Oxford University Press"                              | clear_screen function and list of books with Oxford University Press as publisher will appear                                      | Successful |
| Get books with matching title input                | On second search screen enter: "Active Maths 4"                                       | Book titles "Active Maths 4" output to terminal with publisher and subject fields also populated                                   | Successful |
| Get books with matching title input                | On second search screen enter: "Dictatorship and Democracy"                           | Book titles "Dictatorship and Democracy" output to terminal with publisher and subject fields also populated                       | Successful |
| Get books with matching title input                | On second search screen enter: "Language in Focus"                                    | Book titles "Language in Focus" output to terminal with publisher and subject fields also populated                                | Successful |
| Get books with matching title input                | On second search screen enter: "Human Environment"                                    | Book titles "Human Environment" output to terminal with publisher and subject fields also populated                                | Successful |
| Return the main menu                               | Enter "m" where prompted to return to main menu                                       | User brought back to main menu screen to start search again or quit                                                                | Successful |
| Enter data not in google sheets                    | When prompted to enter Subject, Publisher and Title, entered random letters and words | Error message to advise user that no such book exists in the library under that search and prompt to enter again or return to main | Successful |
| Enter choice at main menu that is not 1, 2 ,3 or 4 | Entered an invalid choice multiple times: picked different numbers beyond 1-4         | Clear screen, error message to advise user they must pick option 1, 2, 3 or 4 and menue shown again below                          | Successful |
| Enter title to checkout - successfully             | When shown checkout option, entered book title                                        | Message display to confirm book to checkout and ask user to input y or n                                                           | Successful |
| Enter title to checkout - unsuccessfully           | When shown checkout option, entered random string or mispelled title                  | Error message to confirm no such book and to try again                                                                             | Successful |
| Checkout confirmation - yes                        | Clicked "y" to confirm checkout of selected book                                      | Clear screen, message to confirm book has been checked out and collect from library, and main menu below to search again or quit   | Successful |
| Checkout confirmation - no                         | Clicked "n" to confirm I did not want to check out                                    | Message to user to try again with another book title or return to search                                                           | Successful |
